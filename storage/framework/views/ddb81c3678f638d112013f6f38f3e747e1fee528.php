<div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img class="img-rounded" src="<?php echo e(asset('assets/foodassets/images/food-picky-logo.png')); ?>" alt=""> </a>
    ...
    </div><?php /**PATH H:\updateDemitrius\Averti\Averti\resources\views/main/food_header.blade.php ENDPATH**/ ?>