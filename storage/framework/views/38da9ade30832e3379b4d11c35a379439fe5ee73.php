		...
		<section class="content">
			<div class="row">
				<div class="col-lg-9 col-md-7 col-12">
					<div class="box box-transparent no-border">
					  <div class="box-header px-0">
						<div class="media align-items-center p-0">
						  <a class="avatar avatar-lg status-success mx-0" href="#">
							<img src="<?php echo e(asset('assets/img/avatars/1.jpg')); ?>" class="rounded-circle" alt="...">
						  </a>
						  <div class="media-body">
							<p class="font-size-16">
							  <a class="hover-primary" href="#"><strong>Sarah Kortney</strong></a>
							</p>
							  2 day ago
						  </div>
						</div>             
						  ...
						  <div class="chat-box-one">
								...
								<div class="card-body">
									<div class="d-flex flex-row pb-2">
										<a class="d-flex" href="#">
											<img alt="Profile" src="<?php echo e(asset('assets/img/avatars/1.jpg')); ?>" class="avatar mr-10">
										</a>
							  ...
							  <div class="card d-inline-block mb-3 float-right mr-2 bg-primary">
								...
								<div class="card-body">
									<div class="d-flex flex-row pb-2">
										<a class="d-flex" href="#">
											<img alt="Profile" src="<?php echo e(asset('assets/img/avatars/4.jpg')); ?>" class="avatar mr-10">
										</a>
										<div class="d-flex flex-grow-1 min-width-zero">
											<div class="m-2 pl-0 align-self-center d-flex flex-column flex-lg-row justify-content-between">
												<div class="min-width-zero">
										...
										<div class="media-list media-list-hover">
											...
											<div class="media py-10 px-0">
											  <a class="avatar avatar-lg status-warning" href="#">
												<img src="<?php echo e(asset('assets/img/avatars/4.jpg')); ?>" alt="...">
											  </a>
											  <div class="media-body">
												<p class="font-size-16">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\updateDemitrius\Averti\Averti\resources\views/chat/chat.blade.php ENDPATH**/ ?>