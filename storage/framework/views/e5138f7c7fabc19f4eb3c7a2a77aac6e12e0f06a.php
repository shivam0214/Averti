			...
			<div class="row">
				...
				<div class="col-md-12 col-lg-4">
				  <div class="box">
					...
					<div class="box-body">
					<a class="d-block" href="<?php echo e(route('staff_list')); ?>" target="_blank">
				...
				<div class="col-md-12 col-lg-4">
				  ...
				  <a href="<?php echo e(route('view_product')); ?>" target="_blank">
					...
					<div class="box-body">
					<a class="d-block" href="<?php echo e(route('view_product')); ?>" target="_blank">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\updateDemitrius\Averti\Averti\resources\views/template/template.blade.php ENDPATH**/ ?>