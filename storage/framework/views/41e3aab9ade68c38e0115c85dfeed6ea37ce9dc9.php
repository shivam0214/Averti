...
<!-- 
    ...
    $('#checkidmsg').hide();
      ...
      e.preventDefault();
        ...
        $.ajax({
                url:'<?php echo e(route("finadvisor")); ?>',
                type:'POST',
                dataType: 'json',
                data:inputData,
                processData:false,
...
<?php echo $__env->make('layouts.frontapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\averti\resources\views/frontview/findadvisor/findadvisor.blade.php ENDPATH**/ ?>