				...
				<div class="box-body">
					...
					<div class="vtabs customvtab">
						...
						<div class="media-list media-list-divided media-list-hover">
							...
							<span class="badge badge-dot badge-success"></span>
							<a class="avatar avatar-lg status-success" href="#">
								<img src="<?php echo e(asset('assets/img/avatars/user.png')); ?>" alt="...">
							</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\averti\resources\views/Mail/group.blade.php ENDPATH**/ ?>