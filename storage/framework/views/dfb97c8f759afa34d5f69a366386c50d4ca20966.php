        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <?php $__currentLoopData = $best_restaurant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            <div class="figure-wrap bg-image" data-image-src="<?php echo e($data['restaurant']['featured_image']); ?>">
                                <div class="distance"><i class="fa fa-pin"></i>1240m</div>
                                <div class="rating pull-left" > 
                                    <i class="fa fa-star" value="<?php echo e($data['restaurant']['user_rating']['aggregate_rating']); ?>"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
                                <div class="review pull-right"><a href="#"><?php echo e($data['restaurant']['all_reviews_count']); ?> reviews</a> </div>
                            </div>
                            <div class="content">
                                <h5><a href="profile.html"><?php echo e($data['restaurant']['name']); ?></a></h5>
                                <div class="product-name"><?php echo e($data['restaurant']['cuisines']); ?></div>
                                <div class="price-btn-block"> <span class="price"><?php echo e($data['restaurant']['currency']); ?> <?php echo e($data['restaurant']['average_cost_for_two']); ?></span> <a href="#" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                            </div>
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="profile.html"> <img src="http://placehold.it/50x46" alt="Restaurant logo" /> </a>
                                    <div class="pull-left right-text"> <a href="#"><?php echo e($data['restaurant']['location']['locality_verbose']); ?></a> <span></span> </div>
                                </div>
                            ...
                            <div class="restaurant-wrap">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                        <a class="restaurant-logo" href="#"> <img src="<?php echo e($value['restaurant']['featured_image']); ?>" alt="Restaurant logo"> </a>
                                    </div>
                                    <!--end:col -->
                                    <div class="col-xs-12 col-sm-9 col-md-12 col-lg-9">
                                        <h5><a href="profile.html"><?php echo e($value['restaurant']['name']); ?></a></h5> 
                                        <span><?php echo e($value['restaurant']['cuisines']); ?></span></br>
                                        <span><?php echo e($value['restaurant']['location']['locality_verbose']); ?></span>

                                        <div class="bottom-part">
                                            <div class="cost"><i class="fa fa-check"></i> Min <?php echo e($value['restaurant']['currency']); ?> <?php echo e($value['restaurant']['average_cost_for_two']); ?></div>
                                            ...
                                            <div class="ratings" > <span>
                                                ...
                                                </span> <?php echo e($value['restaurant']['user_rating']['aggregate_rating']); ?> </div>
                                        </div>
                                    </div>
                                    <!-- end:col -->
                                </div>
