						...
						<div class="media-list media-list-divided media-list-hover">
							<div class="media align-items-center">
								...
								<div class="media-body">
									<p>
									<a href="#"><strong><h4><?php echo e($details['user_staff_booking']['name']); ?></h4></strong></a>
									</p>
									<nav class="nav mt-2">
								...
								<div class="media-right">
									...
									<span>+<?php echo e($details['usermeta_staff_booking']['phone_no']); ?></span> </p>
									<p><i class="ti-email"></i> 
									<span><?php echo e($details['user_staff_booking']['email']); ?></span>
									</p>
