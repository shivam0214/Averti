...
<?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   ...
   <div class="card">
     <div class="card-header" id="exItem2Header">
       <h5 class="mb-0">
         <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#mycode<?php echo e($record['id']); ?>" aria-expanded="false" aria-controls="mycode<?php echo e($record['id']); ?>">   <?php echo e($record['user_data']['name']); ?><p><span>Illness:    <?php echo e($record['disease_list']['disease']); ?></span>
         </p>
         </button>
       </h5>
     </div>
     <div id="mycode<?php echo e($record['id']); ?>" class="collapse chat_list" aria-labelledby="exItem2Header" data-parent="#exampleAccordion">
         <div class="profileinfo">
                   <div class="profilepic">
                   <a  class="avatar avatar-lg status-success" href="#" style="display:none">
								
                    <img src="<?php echo e($record['usermeta_data']['profile_image']); ?>" class="img" alt="..." >
                    </a>
                ...
                <div class="form-group">
                    <label>Chat</label>
                    <button type="button" data-toggle="modal" data-target="#modal-right_chat" onclick="openRoom(<?php echo e($record['user_data']['id']); ?>)" class="btn btn-primary waves-effect waves-light "data-target="#Chat">
                <i class="ti-comment-alt"></i></button>
                  ...
                  <div class="profile-details">
                      <ul>
                          <li >Name: <span class="hover-primary"><?php echo e($record['user_data']['name']); ?> </span></li>
