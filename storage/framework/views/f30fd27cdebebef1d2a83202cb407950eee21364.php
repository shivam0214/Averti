				...
				<div class="row">
                    <div class="col-md-6">
						...
						<div class="tab-pane" id="info">
							<div class="box">
								<!-- /.box-header -->
								<form role="form" method="post" action="<?php echo e(route('update_advisor_data')); ?>">
									<?php echo csrf_field(); ?>
									<?php echo Form::hidden('user_id', $user->id); ?>
						...
						<div class="tab-pane" id="info">
                            <div class="box">           
                            <form role="form" method="post" action="<?php echo e(route('update_user_data')); ?>">
							<?php echo csrf_field(); ?>
							<?php echo Form::hidden('user_id', $user->id); ?>
										...
										<hr class="my-15">
										    <div class="row">
									            <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="occupation" value="<?php echo e($question_data->occupation); ?>" placeholder="Occupation">
                                                    </div>	   
                                                </div>
                                            </div>       
                                     <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-md-8 col-sm-12 col-xs-12">
                                                    ...
                                                    <select name="age" id="age" class="form-control-sm form-control">
                                                        <option value="">Age</option>
                                                        <option value="21-29"<?php if((@$user->single->age)=='21-29'): ?>selected <?php endif; ?>>21-29</option>
                                                        <option value="30-39"<?php if((@$user->single->age)=='30-39'): ?>selected <?php endif; ?>>30-39</option>
                                                        <option value="40-49"<?php if((@$user->single->age)=='40-49'): ?>selected <?php endif; ?>>40-49</option>
                                                        <option value="50-59"<?php if((@$user->single->age)=='50-59'): ?>selected <?php endif; ?>>50-59</option>
														<option value="60-69"<?php if((@$user->single->age)=='60-69'): ?>selected <?php endif; ?>>60-69</option>
                                                        
                                                        <option value="70"<?php if((@$user->single->age)=='70'): ?>selected <?php endif; ?>>70+</opton>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
