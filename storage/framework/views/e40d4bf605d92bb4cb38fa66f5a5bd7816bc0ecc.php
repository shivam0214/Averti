								...
								<?php echo csrf_field(); ?>
									...
									<fieldset>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-lg-12 col-mg-12 col-xs-12 col-sm-12">
													<input type="text" name="Lincense Number" placeholder="Lincense Number">
												</div>
											</div>
										</div>
										<div class="form-group">
...
<?php echo $__env->make('layouts.frontapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\averti\resources\views/frontview/advisorquestion/advisorquestion.blade.php ENDPATH**/ ?>