			...
			<div class="row">
				<div class="col-lg-8 col-md-8">
					...
					<!-- Post -->
									...
									<div class="user-block">
										<img class="img-bordered-sm rounded-circle" src="<?php echo e(asset('../images/user7-128x128.jpg')); ?>" alt="user image">
											<span class="username">
											<a href="#">Nicholas</a>
											<a href="#" class="pull-right btn-box-tool"><i class="fa fa-times"></i></a>
											</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\updateDemitrius\Averti\Averti\resources\views/User/view_profile.blade.php ENDPATH**/ ?>