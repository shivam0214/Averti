...
<nav class="mobile-header primary-menu d-xl-none">
    <div class="header-logo">
        <a href="#" class="logo"><img src="<?php echo e(asset('assets/images/averti.png')); ?>" alt="logo"></a>
    </div>
...
<header class="header-section d-none d-xl-block">
						...
						<div class="row justify-content-between align-items-center">
							...
							<div class="main-menu-area d-flex align-items-center">
								<ul class="main-menu d-flex align-items-center">
									<li><a  href="<?php echo e(route('for_advisor')); ?>">For Advisors</a> </li>
									<li><a  href="<?php echo e(route('for_client')); ?>">For Clients</a> </li>
	...
	<?php /**PATH H:\updateDemitrius\Averti\Averti\resources\views/main/frontheader.blade.php ENDPATH**/ ?>