			...
			<div class="row">
                ...
                <form role="form" method="post" action="<?php echo e(route('advisor_request_send')); ?>">
                  <?php echo csrf_field(); ?>
					...
					<h5>	<p><strong><?php echo e($r_advisor->name); ?></strong> <time class="float-right" datetime="2017-07-14 20:00">24 min ago</time></p></h5>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\averti\resources\views/User/advisor_request.blade.php ENDPATH**/ ?>