                        ...
                        <thead>
                          <tr>
                            ...
                            <tbody style="height:50%">
								...
								<td>
									<img src="{{asset('assets/img/avatars/1.jpg')}}" alt="user avatar" class="customer-img rounded-circle">
								</td>
                                    <td><a href="{{route('view_profile')}}">Sonya Frost</a></td>
                                    <td>+555444555</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('assets/img/avatars/2.jpg')}}" alt="user avatar" class="customer-img rounded-circle"></td>
                                    <td>Sara Jen</td>
                                    <td>+555222333</td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('assets/img/avatars/7.jpg')}}" alt="user avatar" class="customer-img rounded-circle"></td>
                                    <td>Colleen Hurst</td>
                                    <td>+555222444</td>
                                ...
                                <tr>
                                    ...
                                    <td><img src="{{asset('assets/img/avatars/4.jpg')}}" alt="user avatar" class="customer-img rounded-circle"></td>
