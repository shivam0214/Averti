		...
		<section class="content">
			<div class="row">
                ...
                <tr class ="chat_list">
								...
								<td ><a class="hover-primary" href="{{ route('view_profile',['id'=>$record->id]) }}">{{$record['name']}} </a></td>
								...
								<button type="button" data-toggle="modal" data-target="#modal-right_chat" onclick="openRoom({{$record['id']}})" class="btn btn-primary waves-effect waves-light "data-target="#Chat">
