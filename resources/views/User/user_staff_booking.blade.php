		 ...
		 <!-- Step wizard -->
		  <div class="box box-default">
			<div class="box-header with-border">
			  <h4 class="box-title">HI</h4>
			  <h6 class="box-subtitle">What's the reason for you visit today? </h6>		
			</div>
			<!-- /.box-header -->
...
<form method="POST" action="{{route('staff_booking')}}" >
	...
	<div class="formbox">
						<div class="box-header with-border">
						  <h4 class="box-title">Fill Some Details</h4>
						</div>
						<!-- /.box-header -->
						<form class="form">
							<div class="box-body">
                ...
                <label for="where">Description</label>
							...
							<div class="box-footer">
								...
								<button type="submit" class="btn btn-rounded btn-primary btn-outline pull-right mb-20">
								 Submit
								</button>
							</div>  
						</form>
