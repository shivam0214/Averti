					  ...
					  <div class="media-list media-list-divided media-list-hover">
						...
						<div class="media align-items-center">
						  ...
						  <div class="media-right gap-items">
                            ...
                            <a class="action lead" href="{{ route('delete_contact',['id'=>$record->id]) }}" data-toggle="tooltip" title="Remove"><i class="fa fa-fw fa-remove"></i> </a>
						  </div>
						</div>
						@endforeach
					  </div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" method="POST" action="{{route('add_contact')}}">
						@csrf
