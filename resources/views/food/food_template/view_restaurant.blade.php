...
<div class="page-wrapper">
            ...
            <section class="inner-page-hero bg-image" data-image-src="{{asset('assets/images/food_image/bak2.jpg')}}">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><img src="{{$value['featured_image']}}" alt="Food logo"></a>
                                    </figure>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                ...
                                <input type="hidden" name="rest_id" name="id" value="{{$value['id']}}">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min {{$value['currency']}} {{$value['average_cost_for_two']}}</a> </li>
                        ...
                        <div class="sidebar clearfix m-b-20">
                            <div class="main-block">
                                <div class="sidebar-title white-txt">
                                    ...
                                    @foreach($data as $cusine_data)

                                    <ul>
                                    <li><a href="#2" class="scroll">{{$cusine_data['cuisine_name']}}</a></li>
                                 </ul>
                                @endforeach
