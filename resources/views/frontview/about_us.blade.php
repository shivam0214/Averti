...
<!--                </div>-->
            ...
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="row">
              <div class="col-sm-10">
                  <img class="img-fluid rounded" src="{{asset('assets/images/about/12.jpg')}}" alt="logo" width="100%">
                </div>
			...
			<div class="container">
				<div class="row ">
					<div class="col-lg-6 pl-0">
						<div class="plan-img">
							<img src="{{asset('assets/images/about/13.jpg')}}" alt="Image" width="89%">
...
<!--                </div>-->
            ...
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="row">
              <div class="col-sm-10">
                  <img class="img-fluid rounded" src="{{asset('assets/images/about/14.jpg')}}" alt="logo" width="100%">
                </div>
                <!--<div class="col-sm-5 mb-sm-0 mb-4">-->
                <!--  <img class="img-fluid rounded pb-2" src="assets/images/about/03.jpg" alt="logo">-->
                <!--  <div class="bg-primary rounded pie-chart  pie-chart-percentage text-center mt-4">-->
