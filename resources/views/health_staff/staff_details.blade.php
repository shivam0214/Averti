...
@foreach($details as $record)
   ...
   <div class="card">
     <div class="card-header" id="exItem2Header">
       <h5 class="mb-0">
         <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#mycode{{$record['id']}}" aria-expanded="false" aria-controls="mycode{{$record['id']}}">{{$record['user_data']['name']}}</button>
       </h5>
     </div>
     <div id="mycode{{$record['id']}}" class="collapse" aria-labelledby="exItem2Header" data-parent="#exampleAccordion">
         <div class="profileinfo">
                  ...
                  <div class="profile-details">
                      <ul>
                          <li>Name: <span>{{$record['user_data']['name']}} </span></li>
                          ...
                          <li>Duration:<span> {{$record['description']}}</span></li>
