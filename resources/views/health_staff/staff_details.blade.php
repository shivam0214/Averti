...
@foreach($details as $record)
   ...
   <div class="card">
     <div class="card-header" id="exItem2Header">
       <h5 class="mb-0">
         <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#mycode{{$record['id']}}" aria-expanded="false" aria-controls="mycode{{$record['id']}}">{{$record['user_data']['name']}}<p><span>{{$record['disease_list']['disease']}}</span>
         </p>
         </button>
       </h5>
     </div>
