					  ...
					  <div class="box-header px-0">
						<div class="media align-items-center p-0">
						  <a class="avatar avatar-lg status-success mx-0" href="#">
							<img src="{{asset('assets/img/avatars/1.jpg')}}" class="rounded-circle" alt="...">
						  </a>
						  ...
						  <div class="chat-box-one">
								...
								<div class="card-body">
									<div class="d-flex flex-row pb-2">
										<a class="d-flex" href="#">
											<img alt="Profile" src="{{asset('assets/img/avatars/1.jpg')}}" class="avatar mr-10">
										</a>
							  ...
							  <div class="card d-inline-block mb-3 float-right mr-2 bg-primary">
								...
								<div class="card-body">
									<div class="d-flex flex-row pb-2">
										<a class="d-flex" href="#">
											<img alt="Profile" src="{{asset('assets/img/avatars/4.jpg')}}" class="avatar mr-10">
										</a>
										<div class="d-flex flex-grow-1 min-width-zero">
											<div class="m-2 pl-0 align-self-center d-flex flex-column flex-lg-row justify-content-between">
												<div class="min-width-zero">
