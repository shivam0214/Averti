	...
	<!-- scrollToTop ending here -->
  	...
  	<script src="{{asset('assets/frontassets/js/jquery.js')}}"></script>
  	<script src="{{asset('assets/frontassets/js/fontawesome.min.js')}}"></script>
  	<script src="{{asset('assets/frontassets/js/jquery.counterup.min.js')}}"></script>
	<script src="{{asset('assets/frontassets/js/jquery.easing.js')}}"></script>
	<script src="{{asset('assets/frontassets/js/slick.min.js')}}"></script>
  	<script src="{{asset('assets/frontassets/js/lightcase.js')}}"></script>
  	<script src="{{asset('assets/frontassets/js/circular-countdown.js')}}"></script>
  	<script src="{{asset('assets/frontassets/js/jquery.countdown.min.js')}}"></script>
	...
	<script src="{{asset('assets/frontassets/js/jquery.nstSlider.js')}}"></script>
	  ...
	  <script src="{{asset('assets/frontassets/js/jquery.steps.js')}}"></script>
        ...
        <script  src="{{asset('assets/frontassets/js/pricescript.js')}}"></script>
        <script  src="{{asset('assets/frontassets/js/slider.js')}}"></script>
		<script src="{{asset('assets/frontassets/js/zInput.js')}}"></script>
<script>
$(function() {
