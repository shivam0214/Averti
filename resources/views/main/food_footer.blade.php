<section class="app-section">
                        ...
                        <div class="row text-img-block text-xs-left">
                            <div class="container">
                                <div class="col-xs-12 col-sm-6  right-image text-center">
                                    <figure> <img src="{{asset('assets/foodassets/images/app.png')}}" alt="Right Image"> </figure>
                                </div>
    ...
    <script src="{{asset('assets/foodassets/js/jquery.min.js')}}"></script>
    <script src="{{asset('assets/foodassets/js/tether.min.js')}}"></script>
    <script src="{{asset('assets/foodassets/js/bootstrap.min.js')}}"></script>
    <script src="{{asset('assets/foodassets/js/animsition.min.js')}}"></script>
    <script src="{{asset('assets/foodassets/js/bootstrap-slider.min.js')}}"></script>
