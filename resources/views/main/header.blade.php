...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top pl-10">
	  ...
	  <div class="app-menu">
    	...
    	@else
			<li class="btn-group nav-item d-xl-inline-block">
				<a href="{{route('advisor_request')}}" id="request" class="waves-effect waves-light nav-link rounded push-btn" onclick="$('#modal-right').modal('show');" title="View Advisor" role="button">
					<i class="fa fa-user-plus" aria-hidden="true"></i>
			    </a>
			</li>
    	@endif
