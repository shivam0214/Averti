	...
	<div class="d-flex align-items-center logo-box justify-content-between">
		...
		<a href="#" class="logo">
		  ...
		  @if(Auth::user()->role_id==2)
			  <span class="light-logo"><img src="{{asset('assets/images/averti1.png')}}" alt="logo" width="100px"></span>
			  @else
	  ...
	  <div class="app-menu">
		...
		@if(Auth::user()->role_id==2)
		 	<li class="btn-group nav-item d-xl-inline-block">
				<a href="{{route('user_request')}}" class="waves-effect waves-light nav-link rounded push-btn" title="View User Request"  role="button">
					<i class="fa fa-user-plus" aria-hidden="true"></i>
			    </a>
			</li>
    	@else
			<li class="btn-group nav-item d-xl-inline-block">
				<a href="{{route('advisor_request')}}" id="request" class="waves-effect waves-light nav-link rounded push-btn"  title="View Advisor" role="button">
					<i class="fa fa-user-plus" aria-hidden="true"></i>
			    </a>
			</li>
    	@endif
        ...
        <ul class="nav navbar-nav">	
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              <li class="user-body">
				 <a class="dropdown-item" href="{{route('advisor_profile')}}"><i class="ti-user text-muted mr-2"></i> Profile</a>
