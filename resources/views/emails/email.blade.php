                ...
                <tr>
                    <td align="center" valign="top" style="padding: 40px 10px 10px 10px;">
                        <a href="#" target="_blank" style="text-decoration: none;">
							<span style="display: block; font-family: 'Poppins', sans-serif; color: #3e8ef7; font-size: 36px;" border="0"><b>Averti </b> {{Auth::user()['name']}}</span>
                        </a>
                    </td>
                </tr>
            </table>
        ...
        <td align="center" style="padding: 0px 10px 0px 10px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                ...
                <p> Hi {{$data->name}} this is the Zoom meeting invite for you.</p>
                  <p style="margin: 0;">Please Join meeting by click on this link.  </p>
                  <p style="margin: 0;">Meeting time is {{date('Y-m-d',strtotime($data['time']))}}  {{date('H-i a',strtotime($data['time']))}}</p>
                </td>
              </tr>
              <!-- BULLETPROOF BUTTON -->
              <tr>
