                        ...
                        <tbody>
                          ...
                          <tr>
                            <td bgcolor="#ffffff" align="left" style="padding:0; color: #666666; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400;-webkit-font-smoothing:antialiased;">
                                                ...
                                                <p style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">Please confirm that <b><a href="{{URL::to('/#/'.$data['url'])}}" class="__cf_email__" data-cfemail="7e161b1212113e2d1317121b0d3a1f08170d50071b1f16">[email protected]</a></b> is your e-mail address by clicking on the button below </p>
                            </td>
                          </tr>
                                            <tr>
                                              <td align="center">
