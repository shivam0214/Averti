...
@section('gym_content')
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <div class="single-topic text-center mb-30">
                        <div class="topic-img">
                            <img src="{{asset('assets/gym_assets/img/gallery/cat1.png')}}" alt="">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="single-topic text-center mb-30">
                        <div class="topic-img">
                            <img src="{{asset('assets/gym_assets/img/gallery/cat2.png')}}" alt="">
                            <div class="topic-content-box">
                                <div class="topic-content">
                                    <h3>Group traning</h3>
                                    <p>You’ll look at graphs and charts in Task One, how to approach the task and <br> the language needed for a successful answer.</p>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s" >
                        <div class="cat-icon">
                            <img src="{{asset('assets/gym_assets/img/gallery/team1.png')}}" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        <div class="cat-icon">
                            <img src="{{asset('assets/gym_assets/img/gallery/team2.png')}}" alt="">
                        </div>
                        <div class="cat-cap">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-cat text-center mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">
                        <div class="cat-icon">
                            <img src="{{asset('assets/gym_assets/img/gallery/team3.png')}}" alt="">
                        </div>
                        <div class="cat-cap">
                    ...
                    <div class="properties mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="properties__card">
                            <div class="about-icon">
                                <img src="{{asset('assets/gym_assets/img/icon/price.svg')}}" alt="">
                            </div>
                            <div class="properties__caption">
                                ...
                                <div class="single-features">
                                    <div class="features-icon">
                                        <img src="{{asset('assets/gym_assets/img/icon/check.svg')}}" alt="">
                                    </div>
        ...
        <div class="support-wrapper align-items-center">
            <div class="right-content2">
                ...
                <div class="right-img wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                    <img src="{{asset('assets/gym_assets/img/gallery/about.png')}}" alt="">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".4s">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="{{asset('assets/gym_assets/img/gallery/blog1.png')}}" alt="">
                            </div>
                            <div class="blog-cap">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="home-blog-single mb-30 wow fadeInUp" data-wow-duration="2s" data-wow-delay=".6s">
                        <div class="blog-img-cap">
                            <div class="blog-img">
                                <img src="{{asset('assets/gym_assets/img/gallery/blog2.png')}}" alt="">
                            </div>
                            <div class="blog-cap">
                                <span>Gym & Fitness</span>
                                <h3><a href="blog_details.html">Your Antibiotic One Day To 10 Day Options</a></h3>
    ...
    <!-- Blog Area End -->
    <!--? video_start -->
    <div class="video-area section-bg2 d-flex align-items-center"  data-background="{{asset('assets/gym_assets/img/gallery/video-bg.png')}}">
        <div class="container">
            ...
            <div class="row justify-content-between">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-8">
                    <div class="single-services mb-40 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s">
                        <div class="features-icon">
                            <img src="{{asset('assets/gym_assets/img/icon/icon1.svg')}}" alt="">
                        </div>
                        <div class="features-caption">
                            <h3>Location</h3>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                    <div class="single-services mb-40 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
                        <div class="features-icon">
                            <img src="{{asset('assets/gym_assets/img/icon/icon2.svg')}}" alt="">
                        </div>
                        <div class="features-caption">
                            <h3>Phone</h3>
                            <p>(90) 277 278 2566</p>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-8">
                    <div class="single-services mb-40 wow fadeInUp" data-wow-duration="2s" data-wow-delay=".4s">
                        <div class="features-icon">
                            <img src="{{asset('assets/gym_assets/img/icon/icon3.svg')}}" alt="">
                        </div>
                        <div class="features-caption">
                            <h3>Email</h3>
